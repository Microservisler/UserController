...
using UserController.Admin.Api.Configuration;
using UserController.Admin.Api.Configuration.Authorization;
using UserController.Admin.Api.ExceptionHandling;
using UserController.Admin.Api.Helpers;
using UserController.Admin.Api.Resources;
using UserController.Admin.Api.DbContexts;
using UserController.Admin.Api.Entities.Identity;
using Skoruba.IdentityServer4.Shared.Configuration.Helpers;
using Project2.Shared.Dtos.Identity;
using UserController.Admin.Api.Mappers;
using UserController.Admin.Api.Dtos;

namespace UserController.Admin.Api
{
