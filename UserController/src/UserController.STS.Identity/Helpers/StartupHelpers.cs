...
using System.Linq;
using UserController.STS.Identity.Configuration;
using UserController.STS.Identity.Configuration.ApplicationParts;
using UserController.STS.Identity.Configuration.Constants;
using UserController.STS.Identity.Configuration.Interfaces;
using UserController.STS.Identity.Helpers.Localization;

namespace UserController.STS.Identity.Helpers
{
